# from BallR https://github.com/toddwschneider/ballr/blob/master/hex_chart.R
...
generate_hex_chart = function(hex_data, base_court, court_theme = default_theme, metric = sym(bounded_fg_diff), alpha_range = c(0.85, 0.98)) {
